...
namespace UAPA
{
    ...
    public partial class fmrfacilitador : Form
    {
        ...
        SqlConnection conecxionsql = new SqlConnection(@"Data Source=DESKTOP-EVQDN0O;Initial Catalog=UAPA;Integrated Security=True");
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(datatimefac.Text) == true)
            {
                MessageBox.Show(" Para continuar debe llenar este campo ");
                datatimefac.Focus();
                return;
            ...
            if (string.IsNullOrWhiteSpace(txtcod.Text) == true)
            {
                string codigo = "0";
                ...
                tipos.fc_ingre_fac = datatimefac.Text;
            ...
            else
            {
                ...
                clase_tipo_datosfc tipos = new clase_tipo_datosfc();
                tipos.cod_fac = int.Parse(txtcod.Text);
                tipos.nom_fac = txtnom.Text;
                tipos.apellido_fac = txtape.Text;
                tipos.tp_docu_iden_fac = cmbdoc.Text;
                tipos.iden_fac = txtide.Text;
        ...
        private void btnconsulta_Click(object sender, EventArgs e)
        {
            ...
            if (txtconsultaf.Text == "")
            {
                ...
                SqlCommand comando = new SqlCommand(sentencia, conecxionsql);
        ...
        private void dgvconsultaf_DoubleClick(object sender, EventArgs e)
        {
           int fila = dgvconsultaf.CurrentRow.Index;
            ...
            {
                txtcod.Text = dgvconsultaf.Rows[fila].Cells[0].Value.ToString();
                ...
                datatimefac.Text = dgvconsultaf.Rows[fila].Cells[12].Value.ToString();
